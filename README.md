...
* **Opcja automatyczna (Zalecana):** Otwórz menu aplikacji (przycisk ☰) i wybierz **"Reset Aplikacji"**. Spowoduje to wyczyszczenie danych i ponowne załadowanie najnowszej wersji. (Czasem wymaga to chwili, aż nowe zasoby zostaną pobrane, wystarczy poczekać, aplikacja sama się uruchomi. Wszystko jest zależne od prędkości Twojego urządzenia i Internetu.)
